    ...
    function AddSampleData() {
        fetch('../sampleData.json')
            ...
            for (const [key, value] of Object.entries(data.volunteers)) {
                ...
                const volunteer = new Volunteer(value.firstName, value.lastName, value.emailAddress, value.password, value.admin || false, value.websiteVisits || 0, value.eventsAttended || []);
