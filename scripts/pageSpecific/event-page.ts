...
async function HighlightEventDate(event: EventData) {
...
async function DisplayUpcomingEvents() {
    ...
    const CheckBoxFundraisers = document.getElementById("CheckBoxFundraisers") as HTMLInputElement;
    const CheckBoxWorkshops = document.getElementById("CheckBoxWorkshops") as HTMLInputElement;
    const CheckBoxCleanups = document.getElementById("CheckBoxCleanups") as HTMLInputElement;

    if (!EventList || !CheckBoxFundraisers || !CheckBoxWorkshops || !CheckBoxCleanups) return;
...
export async function DisplayEventsPage() {
    ...
    const checkboxes = {
        fundraisers: document.getElementById("CheckBoxFundraisers") as HTMLInputElement,
        workshops: document.getElementById("CheckBoxWorkshops") as HTMLInputElement,
        cleanups: document.getElementById("CheckBoxCleanups") as HTMLInputElement
    };

    if (!checkboxes.fundraisers || !checkboxes.workshops || !checkboxes.cleanups) return;
