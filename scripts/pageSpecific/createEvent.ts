...
export function DisplayCreateEventPage() {
    ...
    form.addEventListener('submit', (event) => {
        ...
        const eventContact = (document.getElementById('eventContact') as HTMLInputElement).value;
        const volunteerPositions = parseInt((document.getElementById('volunteerPositions') as HTMLInputElement).value);
